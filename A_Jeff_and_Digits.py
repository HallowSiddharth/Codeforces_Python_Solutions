...
5. since we can use less than the given numbers, 
we find out what is the closest multiple of 9 5s and then 
...
# if there is no 5, answer is 0
# if there is no 0, answer is -1
# else, print highest number
